/**
 * This class represents a large office with a floor heating.
 */
@Responsible(groupMember = "Catalin", description = "Implementation of the structure suggested by Subair")
public class LargeOfficeFloorHeating extends Office {

    /**
     * Constructor for the LargeOfficeFloorHeating class that initializes the heat pump.
     *
     * @param heatPump the heat pump to be assigned to the large office with floor heating
     */
    @Precondition(description = "heatPump != null")
    @Postcondition(description = "The heat pump is assigned to the large office with floor heating")
    LargeOfficeFloorHeating(HeatPump heatPump) {
        super(heatPump);
    }

    /**
     * Assigns a heat pump to the large office with floor heating. Returns the assigned heat pump, or null if the
    ...
    /**
     * Returns null. This method is not available for large offices.
     *
     * @param heatPump the heat pump to be assigned
     * @return null
     */
    ...
    public String getType() {
        return "Large Office with Floor Heating";
    }
}