/**
 * This class represents a medium office with a radiator.
 */
@Responsible(groupMember = "Catalin", description = "Implementation of the structure suggested by Subair")
public class MediumOfficeRadiator extends Office {

    /**
     * Constructor for the MediumOfficeRadiator class that initializes the heat pump.
     *
     * @param heatPump the heat pump to be assigned to the medium office with radiator
     */
    ...
    MediumOfficeRadiator(HeatPump heatPump) {
        super(heatPump);
    }

    /**
     * Assigns a heat pump to the medium office with radiator. Returns the assigned heat pump, or null if the
    ...
    /**
     * Tries Assigning a high power heat pump to the medium office with radiator.
    ...
    public String getType() {
        return "Medium Office with Radiator";
    }
}
